                ...
                return (
                  <Card key={announcement.id} className={`overflow-hidden transition-all ${announcement.is_urgent ? 'border-l-4 border-l-red-500 bg-red-50/30' : ''
                    ...
                    <CardHeader className="pb-2 pt-4 flex flex-row items-start justify-between">
                      ...
                      {isLecturer && (
                        <form action={async (formData: FormData) => { 'use server'; await deleteAnnouncement(announcement.id, courseId) }}>
                ...
                <Card key={file.id} className="flex flex-col p-4 hover:shadow-md hover:border-blue-200 transition-all duration-200 group">
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <div className="flex gap-1">
                      ...
                      {isLecturer && (
                        <form action={async (formData: FormData) => { 'use server'; await deleteMaterial(file.id, courseId, formData) }}>
                    ...
                    <CardHeader className="pb-2 flex flex-row items-start justify-between space-y-0">
                      ...
                      {isLecturer && (
                        <div className="flex items-center gap-1 -mt-1 -mr-2">
                          ...
                          <form action={async (formData: FormData) => { 'use server'; await deleteAssignment(assignment.id, courseId, formData) }}>
